...
- **事实源与记忆**：任务使用原生 Hermes Kanban；旧审批归属表仅为档案，不再读写；聊天已迁移原生 Hermes SessionDB、MEMORY/USER，按账号隔离，旧对话一次性导入。经确认的长期协作安排可更新记忆；原生 Kanban 已接管任务，未接入外部看板；详见 [0010](docs/decisions/0010-native-kanban.md)。
